...
canaltour = Experience.create!(name: "Joes Canal Tour", price:"50", description:"such water, much wow!", host_info:hostjoe, location: amsterdam, featured_ngo: redcross.id, photo:"https://res.cloudinary.com/greggstyle/image/upload/v1529099386/xipqak07dqbfpwrqopaq.jpg")

cycling = Experience.create!(name: "Joes Cycling Tour", description:"much cycle, very pain!", host_info:hostjoe, location: amsterdam)
